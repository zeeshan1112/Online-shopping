...
<a href="contact.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <img src="images/Superman - Man Of Steel.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
    <div class="section">
  	  <p>A young itinerant worker is forced to confront his secret extraterrestrial heritage when Earth is invaded by members of his race.</p>
    ...
    <form method="post" action="superman.jsp">
