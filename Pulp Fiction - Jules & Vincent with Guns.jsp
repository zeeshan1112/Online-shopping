 ...
 <a href="home.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <h2>Pulp Fiction - Jules & Vincent with Guns</h2>
      <img src="images/Pulp Fiction - Jules & Vincent with Guns.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
    ...
    <form method="post" action="pulp.jsp">
