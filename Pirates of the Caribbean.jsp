 ...
 <a href="home.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <img src="images/Pirates of the Caribbean.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
    <div class="section">
  	  <p>Jack Sparrow and Barbossa embark on a quest to find the elusive fountain of youth, only to discover that Blackbeard and his daughter are after it too.</p>
    ...
    <form method="post" action="pirates.jsp">
