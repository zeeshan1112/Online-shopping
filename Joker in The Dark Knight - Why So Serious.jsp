 ...
 <a href="home.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <h2>Joker in The Dark Knight - Why So Serious</h2>
      <img src="images/Joker in The Dark Knight - Why So Serious.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
    <div class="section">
  	  <p>When Batman, Gordon and Harvey Dent launch an assault on the mob, they let the clown out of the box, the Joker, bent on turning Gotham on itself and bringing any heroes down to his level.</p>
    ...
    <form method="post" action="joker.jsp">
