...
<title>Our Plan - Bane Poster</title>
</head>
<body>
 ...
 <a href="home.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <h2>Our Plan - Bane Poster</h2>
      <img src="images/Our Plan - Bane Poster.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
    <div class="section">
  	  <p>Bane is an escaped convict from an island prison in South America and a super-villain/assassin. Bane has abnormal physical strength as a result of having had undergone experiments involving a derivative of the drug Venom. He became known as "The Man Who Broke the Bat" when he broke Batman's back, forcing Bruce Wayne to give up the Batman persona while he recuperated.</p>
    ...
    <form method="post" action="bane.jsp">
