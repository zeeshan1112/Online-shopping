 ...
 <a href="home.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <h2>Godfather - A Mafia Masterpiece</h2>
      <img src="images/Godfather - A Mafia Masterpiece.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
   ...
   <%
    ...
    <form method="post" action="godfather.jsp">
