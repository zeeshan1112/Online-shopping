 ...
 <a href="home.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <h2>The Dark Knight Rises - Batman Collection</h2>
      <img src="images/The Dark Knight Rises - Batman Collection.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
    ...
    <form method="post" action="dark.jsp">
