 ...
 <a href="home.jsp" style="text-decoration:none";>
  ...
  <div class="col threeQuarter border">
    <div class="section">
      ...
      <h2>Inception</h2>
      <img src="images/Inception.jpg" draggable="false" class="itemImg" />
    </div>
  ...
  <div class="col quarter padding">
    <div class="section">
  	  <p>A skilled extractor is offered a chance to regain his old life as payment for a task considered to be impossible.</p>
    ...
    <form method="post" action="incep.jsp">
